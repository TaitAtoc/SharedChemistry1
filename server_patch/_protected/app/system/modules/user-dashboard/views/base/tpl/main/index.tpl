...
<style>
    ...
    main#content{max-width:1180px!important;margin:0 auto!important;padding:12px 15px 0!important;background:transparent!important}
    ...
    @media (max-width:767px){main#content{padding-left:10px!important;padding-right:10px!important}.navbar-toggle{display:block!important}.sc-dashboard-card{padding:14px!important}.sc-public-photo-row{grid-template-columns:repeat(2,minmax(0,1fr))!important}.sc-profile-actions a,.sc-dashboard-button{width:100%!important}}
</style>
{/literal}
