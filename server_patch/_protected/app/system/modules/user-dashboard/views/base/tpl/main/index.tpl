<style scoped="scoped">
    ...
    @media (max-width:767px){header #headings,main#content{padding-left:10px!important;padding-right:10px!important}.navbar-toggle{display:block!important}.sc-dashboard-card{padding:14px}}
</style>
