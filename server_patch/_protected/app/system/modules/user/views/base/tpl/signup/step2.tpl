<style>
    ...
    .sharedchemistry-step-card .radio input,
    .sharedchemistry-step-card .checkbox input {
        margin-top: 2px;
    }
...
<div class="col-md-12 sharedchemistry-signup-wrap sharedchemistry-signup-step2">
    ...
    >
        ...
        <p style="margin:0;color:#d7d2ce;font-size:16px;line-height:1.6;">Start with the essentials that make your SharedChemistry profile feel real and welcoming.</p>
    </section>
