...
class ForumController extends Controller
{
    ...
    public function post()
    {
        ...
        if (empty($oPost)) {
            ...
            $this->view->post_extra = $this->oForumModel->getTopicExtra((int)$oPost->topicId);
            $this->view->post_photos = $this->oForumModel->getTopicPhotos((int)$oPost->topicId);
    ...
    {
        // SC_FORUM_NO_WORD_CENSOR_V1_ACTIVE
        return str_replace(' ', ',', $sTitle);
    }
    ...
    {
        // SC_FORUM_NO_WORD_CENSOR_V1_ACTIVE
        return $this->str->escape($sTitle, true);
    }
