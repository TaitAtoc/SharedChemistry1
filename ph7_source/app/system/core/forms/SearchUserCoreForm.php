    ...
    public static function quick($iWidth = null, $bSetDefVals = true)
    {
        ...
        $oForm->addElement(
            new Checkbox(
                ...
                SearchQueryCore::SEX,
                [
                    "social_meetups" => t('Social meetups'),
                    "watching" => t('Watching'),
                    "soft_swap" => t('Soft swap'),
                    "full_swap" => t('Full swap'),
                    "oral" => t('Oral'),
                    "same_room_play" => t('Same-room play'),
                    "separate_room_play" => t('Separate-room play'),
                    "parties_events" => t('Parties and events')
                ],
